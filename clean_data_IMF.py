...
input_files = [
    './News_all/imf_news_data/imf_news_full.csv',
    './News_all/imf_news_data/imf_news_full_2022-2024.csv',
    './News_all/imf_news_data/imf_news_full_2024.csv'
]  # List of input CSV files

output_file = 'imf_news_cleaned.csv'  # Output CSV file
