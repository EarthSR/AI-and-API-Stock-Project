...
# ตั้งค่า encoding สำหรับ stdout
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

# ===== STEP 1: Load Dataset =====
file_path = os.path.join(os.path.dirname(__file__), "News", "USA_News_Hybrid.csv")
...
output_path = os.path.join(os.path.dirname(__file__), "News", "daily_sentiment_summary_USA.csv")
daily_sentiment.to_csv(output_path, index=False)

print("✅ Summary file saved → daily_sentiment_summary_USA.csv")