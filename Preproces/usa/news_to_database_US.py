...
try:
    ...
    # ✅ โหลดไฟล์ข่าว
    file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'usa', 'News', 'USA_News_Hybrid.csv')
    ...
    for _, row in tqdm(df_new.iterrows(), total=len(df_new), desc="📰 Inserting news"):
